...
class AgriculturalLLM:
    """Enhanced LLM for agricultural advice with multiple model options"""
    
    def __init__(self, model_name: str = None):
        """
        Initialize LLM with automatic model selection
    ...
    def generate_response(self, query: str, context: str, language: str = "en") -> str:
        ...
        try:
            ...
            if not response or len(response) < 10:
                response = self._generate_fallback_response(query, context, language)
...
def get_llm(model_name: str = None) -> AgriculturalLLM:
    """Get or create LLM instance"""
    global _llm_instance
    if _llm_instance is None:
        _llm_instance = AgriculturalLLM(model_name)
    return _llm_instance

def generate_response(query: str, context: str, language: str = "en") -> str:
...
if __name__ == "__main__":
    ...
    test_query = "How much water does wheat need?"
    test_context = "Wheat requires moderate irrigation. Water at sowing, tillering, and grain filling stages for best yield."
